    ...
    public class SettingsServices
    {
        ...
        public void DeleteAll()
        {
            using (var db = new almohandes_DbEntities())
            {
                ...
                //Home Pages
                var HomeSetting = new HomePage
                {
                    PageId = 27,
                    DisplayOrder = 1,
                };
                db.HomePages.Add(HomeSetting);
                db.SaveChanges();

                var HomeSetting2 = new HomePage
                {
                    PageId = 32,
                    DisplayOrder = 5,
                };
                db.HomePages.Add(HomeSetting2);
                db.SaveChanges();

                var HomeSetting3 = new HomePage
                {
                    PageId = 28,
                    DisplayOrder = 2,
                };
                db.HomePages.Add(HomeSetting3);
                db.SaveChanges();

                var HomeSetting4 = new HomePage
                {
                    PageId = 29,
                    DisplayOrder = 3,
                };
                db.HomePages.Add(HomeSetting4);
                db.SaveChanges();

                var HomeSetting5 = new HomePage
                {
                    PageId = 30,
                    DisplayOrder = 4,
                };
                db.HomePages.Add(HomeSetting5);
                db.SaveChanges();

                var HomeSetting6 = new HomePage
                {
                    PageId = 36,
                    DisplayOrder = 6,
                };
                db.HomePages.Add(HomeSetting6);
                db.SaveChanges();

                var HomeSetting7 = new HomePage
                {
                    PageId = 37,
                    DisplayOrder = 7,
                };
                db.HomePages.Add(HomeSetting7);
                db.SaveChanges();

                var HomeSetting8 = new HomePage
                {
                    PageId = 53,
                    DisplayOrder = 8,
                };
                db.HomePages.Add(HomeSetting8);
                db.SaveChanges();
            }

        }

        public ResultDto<Setting> AddNewPage(Page model, Guid UserId)
        {
            using (var dbContext = new almohandes_DbEntities())
            {
                var result = new ResultDto<Setting>();
