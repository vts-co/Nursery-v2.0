...
namespace NurseryProject.Utilities
{
    public static class Buttons
    {
        ...
        {
            return new MvcHtmlString($"<button type='submit' class='btn btn-primary  waves-effect waves-light px-3 m-1 col-12 col-md-auto'><i class='fas fa-plus me-1'></i>حفظ</button>");
        }
